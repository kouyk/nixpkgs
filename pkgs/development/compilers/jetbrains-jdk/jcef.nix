...
in stdenv.mkDerivation rec {
  ...
  commit-num = "541";  # Run `git rev-list --count HEAD`
  ...
  cef-bin = let
    fileName = "cef_binary_98.3.34+g97a5ae6+chromium-98.0.4758.102_linux64_minimal";
    urlName = builtins.replaceStrings ["+"] ["%2B"] fileName;
  in fetchzip rec {
    name = fileName;
    url = "https://cache-redirector.jetbrains.com/intellij-jbr/${urlName}.zip";
    hash = "sha256-+tlJwue5LDP0hwzPdy9mSiRyTllkSTQUFce1tlZxL1A=";
  };
  clang-fmt = fetchurl {
